...
class CreditHistoryToCsvTest {
    ...
    void whenCreditHistoryTxtRead_andCsvGenerated_thenCsvCorrect() throws IOException {
        ...
        softly.assertThat(firstOperation.get(5)).isEqualTo("KAPITAŁ ODSETKI 100.00 ODSETKI PRZETERMINOWANE 1.00 KWOTA RATY (KAPITAŁ + ODSETKI) 400.00 PŁATNOŚĆ CZĘŚCIOWA - WAL/PLN PLN1604.00");
    ...
    void whenCreditHistoryTxtRead_andCsvGenerated_thenCsvWithHeaderCorrect() throws IOException {
        ...
        softly.assertThat(firstOperation.get(OPERATION_TITLE_HEADER_5)).isEqualTo("KAPITAŁ ODSETKI 100.00 ODSETKI PRZETERMINOWANE 1.00 KWOTA RATY (KAPITAŁ + ODSETKI) 400.00 PŁATNOŚĆ CZĘŚCIOWA - WAL/PLN PLN1604.00");
